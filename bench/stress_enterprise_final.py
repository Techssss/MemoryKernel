...
def bulk_insert_memories(db_path, count, batch_size=2000):
    ...
    for i in range(0, count, batch_size):
        ...
        for j in range(actual_batch):
            ...
            data.append((str(uuid_hex()), text, encode_embedding(vec), 0.5, 1.0, datetime.utcnow().isoformat()))
...
async def run_final_benchmark(total_items=10000):
    ...
    test_dir = Path("d:/WorkSpace/AI/MemoryKernel/bench_tmp_final").resolve()
    ...
    if any("ZULU_CORE" in r["content"] for r in res):
